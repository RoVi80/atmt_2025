...
#SBATCH --output=toy_example_cpu.out
...
ROOT="$HOME/data/atmt_2025"
cd "$ROOT" || { echo "Repo not found at $ROOT"; exit 1; }

# clean up from previous runs
rm -rf toy_example/data/prepared toy_example/tokenizers toy_example/checkpoints toy_example/logs
...
python train.py \
    ...
    --arch transformer \
    --max-epoch 10 \
    --log-file toy_example/logs/train_cpu.log \
